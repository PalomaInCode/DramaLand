...
function votarPorNome(req, res) {
  var nomeDorama = req.params.nomeDorama;
  console.log("Dorama recebido:", nomeDorama);

  votoModel.atualizarVoto(nomeDorama)                             // invoca a função da model para atualizar os votos
